...
def prepare_train_data(azadpur_high_anomaly,azadpur_mandi,azadpur_mandi_residual,lucknow_high_anomaly,
    ...
    #print(x1.shape)
    x2,y2=prepare(lucknow_high_anomaly,lasalgaon_mandi,lasalgaon_mandi_residual,days)
    #print(x2.shape)
...
def final_model(days,azadpur_mandi,lasalgaon_mandi,
                ...
                azadpur_high_anomaly,lucknow_high_anomaly):
...
#                        [lasalgaon_mandi-lasalgaon_mandi_arimax2],kolkata_high_anomaly,
