...
total_anomalies=len(kolkata_low_anomaly)+len(lucknow_low_anomaly)

#print('mandi')
#train_test_function(lucknow_mandi,kalyani_mandi,[lucknow_mandi],[kalyani_mandi],'mandi price',lucknow_low_anomaly,kolkata_low_anomaly)
##
#print('retail price')
#train_test_function(lucknow_retail,kolkata_retail,[lucknow_retail],[kolkata_retail],'retail price',lucknow_low_anomaly,kolkata_low_anomaly)

#print('Arrival')
#train_test_function(lucknow_arrival,kalyani_arrival,[lucknow_arrival],[kalyani_arrival],'arrival',lucknow_low_anomaly,kolkata_low_anomaly)
##
#print('retail and mandi')
#train_test_function(lucknow_retail,kolkata_retail,[lucknow_mandi],[kalyani_mandi],'retail and mandi price',lucknow_low_anomaly,kolkata_low_anomaly)
##
#print('mandi and retail')
#train_test_function(lucknow_mandi,kalyani_mandi,[lucknow_retail],[kolkata_retail],'mandi and retail',lucknow_low_anomaly,kolkata_low_anomaly)

#print('arrival and mandi')
#train_test_function(lucknow_arrival,kalyani_arrival,[lucknow_mandi],[kalyani_mandi],'arrival and mandi price',lucknow_low_anomaly,kolkata_low_anomaly)
#
#print('mandi and arrival')
#train_test_function(lucknow_mandi,kalyani_mandi,[lucknow_arrival],[kalyani_arrival],'mandi and arrival',lucknow_low_anomaly,kolkata_low_anomaly)

#print('arrival and retail')
#train_test_function(lucknow_arrival,kalyani_arrival,[lucknow_retail],[kolkata_retail],'arrival and retail',lucknow_low_anomaly,kolkata_low_anomaly)
#
#print('retail and arrival')
#train_test_function(lucknow_retail,kolkata_retail,[lucknow_arrival],[kalyani_arrival],'retail and arrival',lucknow_low_anomaly,kolkata_low_anomaly)
#
#print('mandi and residual')
#train_test_function(lucknow_mandi,kalyani_mandi,[lucknow_mandi-lucknow_mandi_arimax2],[kalyani_mandi-kalyani_mandi_arimax2],'mandi and residuals',lucknow_low_anomaly,kolkata_low_anomaly)
##
#print('residual and mandi')
#train_test_function(lucknow_mandi-lucknow_mandi_arimax2,kalyani_mandi-kalyani_mandi_arimax2,[lucknow_mandi,lucknow_retail],[kalyani_mandi,kolkata_retail],'arrival, retail-mandi',lucknow_low_anomaly,kolkata_low_anomaly)
#
#
#
#print('arrival, retail-mandi')
#train_test_function(lucknow_retail-lucknow_mandi,kolkata_retail-kalyani_mandi,[lucknow_arrival],[kalyani_arrival],'arrival, retail-mandi',lucknow_low_anomaly,kolkata_low_anomaly)
#
##
print('arrival, retail and mandi')
train_test_function(lucknow_arrival,kalyani_arrival,[lucknow_mandi,lucknow_retail],[kalyani_mandi,kolkata_retail],'arrival, retail and mandi',lucknow_low_anomaly,kolkata_low_anomaly)
