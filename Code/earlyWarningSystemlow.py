...
def prepare_train_data(azadpur_low_anomaly,azadpur_mandi,lasalgaon_low_anomaly,
                       lasalgaon_mandi,bangalore_low_anomaly,bangalore_mandi,days):
    #print('x1')
    x1,y1=prepare(azadpur_low_anomaly,azadpur_mandi,days)
    
    #print('x2')
    x2,y2=prepare(lasalgaon_low_anomaly,lasalgaon_mandi,days)
...
#print(len(azadpur_low_anomaly),len(bangalore_low_anomaly),len(lasalgaon_low_anomaly))


#print('------------------------Mandi Price----------------------------------')     
#actual_labels,predicted_labels=final_model(29,[azadpur_mandi],[bangalore_mandi],[lasalgaon_mandi],
#                        [azadpur_mandi_arimax2],[bangalore_mandi_arimax2],[lasalgaon_mandi_arimax2],
#                        azadpur_low_anomaly,bangalore_low_anomaly,lasalgaon_low_anomaly)
...
#print('-------------------------Arrival-------------------------------------------')
#actual_labels,predicted_labels=final_model(29,[azadpur_arrival],[bangalore_arrival],[lasalgaon_arrival],
#                        [azadpur_arrival_arimax2],[bangalore_arrival_arimax2],[lasalgaon_arrival_arimax2],
#                        azadpur_low_anomaly,bangalore_low_anomaly,lasalgaon_low_anomaly)


#print('----------------------Retail----------------------------------------------')
#actual_labels,predicted_labels=final_model(29,[delhi_retail],[bangalore_retail],[mumbai_retail],
#                        [delhi_retail_arimax2],[bangalore_retail_arimax2],[mumbai_retail_arimax2],
#                        azadpur_low_anomaly,bangalore_low_anomaly,lasalgaon_low_anomaly)


#print('-------------------Arrival and Mandi----------------------------')
#actual_labels,predicted_labels=final_model(29,[azadpur_arrival,azadpur_mandi],[bangalore_arrival,bangalore_mandi],[lasalgaon_arrival,lasalgaon_mandi],
...
#actual_labels,predicted_labels=final_model(29,[delhi_retail,azadpur_mandi],[bangalore_retail,bangalore_mandi],[mumbai_retail,lasalgaon_mandi],
...
#actual_labels,predicted_labels=final_model(29 ,[delhi_retail,azadpur_arrival],[bangalore_retail,bangalore_arrival],[mumbai_retail,lasalgaon_arrival],
...
actual_labels,predicted_labels=final_model(29,[delhi_retail,azadpur_arrival,azadpur_mandi],[bangalore_retail,bangalore_arrival,bangalore_mandi],[mumbai_retail,lasalgaon_arrival,lasalgaon_mandi],
