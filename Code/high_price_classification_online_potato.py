...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 18 08:52:52 2020
...
#    model = RandomForestClassifier(max_depth=3, random_state=0,n_estimators=20)
...
def final_model(days,lucknow_mandi,kalyani_mandi,
    ...
    lucknow_low_anomaly=lucknow_low_anomaly[(lucknow_low_anomaly[2]=='hoarding') | (lucknow_low_anomaly[2]=='weather')]
    kolkata_low_anomaly=kolkata_low_anomaly[(kolkata_low_anomaly[2]=='hoarding') | (kolkata_low_anomaly[2]=='weather')]
