...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 17 23:02:56 2020
...
def train_test_function(azadpur_anomalies,bangalore_anomalies,lasalgaon_anomalies,train_end_date,test_end_date):
    ...
    azadpur_anomalies=azadpur_anomalies[azadpur_anomalies[2]!='no']
    lasalgaon_anomalies=lasalgaon_anomalies[lasalgaon_anomalies[2]!='no']
    bangalore_anomalies=bangalore_anomalies[bangalore_anomalies[2]!='no']
