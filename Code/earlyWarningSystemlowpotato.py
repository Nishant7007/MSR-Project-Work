...
#print(len(kolkata_low_anomaly))
#print(len(lucknow_low_anomaly))
#print('------------------------Mandi Price----------------------------------')     
#actual_labels,predicted_labels=final_model(29,[lucknow_mandi],[kalyani_mandi],
#                        [lucknow_mandi_arimax2],[kalyani_mandi_arimax2],
#                        lucknow_low_anomaly,kolkata_low_anomaly)


#print('------------------------Arrival----------------------------------')     
#actual_labels,predicted_labels=final_model(29,[lucknow_arrival],[kalyani_arrival],
#                        [lucknow_arrival_arimax2],[kalyani_arrival_arimax2],
#                        lucknow_low_anomaly,kolkata_low_anomaly)

#
#print('-------------------Arrival and Mandi----------------------------')
#actual_labels,predicted_labels=final_model(29,[lucknow_arrival,lucknow_mandi],[kalyani_arrival,kalyani_mandi],
#                        [lucknow_arrival_arimax2,lucknow_mandi_arimax2],[kalyani_arrival_arimax2,kalyani_mandi_arimax2]
#                        ,lucknow_low_anomaly,kolkata_low_anomaly)

#
#print('----------------------Retail----------------------------------------------')
#actual_labels,predicted_labels=final_model(29,[lucknow_retail],[kolkata_retail],
#                        [lucknow_retail_arimax2],[kolkata_retail_arimax2],
#                        lucknow_low_anomaly,kolkata_low_anomaly)


#print('----------------Mandi and Retail---------------------------------------------')
#actual_labels,predicted_labels=final_model(29,[lucknow_retail,lucknow_mandi],[kolkata_retail,kalyani_mandi],
#                        [lucknow_retail_arimax2,lucknow_mandi_arimax2],[kolkata_retail_arimax2,kalyani_mandi_arimax2],
#                        lucknow_low_anomaly,kolkata_low_anomaly)
#
#print('----------------arrival and Retail---------------------------------------------')
#actual_labels,predicted_labels=final_model(29,[lucknow_retail,lucknow_arrival],[kolkata_retail,kalyani_arrival],
...
actual_labels,predicted_labels=final_model(29,[lucknow_retail,lucknow_arrival,lucknow_mandi],[kolkata_retail,kalyani_arrival,kalyani_mandi],
