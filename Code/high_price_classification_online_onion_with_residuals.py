...
# -*- coding: utf-8 -*-
"""
Created on Tue Feb 18 09:27:38 2020
...
def prepare_train_data(azadpur_high_anomaly,azadpur_mandi,azadpur_mandi_residual,lasalgaon_high_anomaly,
                       lasalgaon_mandi,lasalgaon_mandi_residual,bangalore_high_anomaly,bangalore_mandi,
                       bangalore_mandi_residual,days):
    x1,y1=prepare(azadpur_high_anomaly,azadpur_mandi,azadpur_mandi_residual,days)
#    print(x1.shape)
    x2,y2=prepare(lasalgaon_high_anomaly,lasalgaon_mandi,lasalgaon_mandi_residual,days)
#    print(x2.shape)
...
#    print('train model')
    ...
    min_samples_leaf = [int(x) for x in range(2,20)]
    bootstrap = [True,False]
    #oob_score=[True,False]
    random_grid = {'n_estimators': n_estimators,
                   'max_features': max_features,
                   ...
                   'bootstrap': bootstrap}
#    rf = RandomForestClassifier()
#    model = RandomizedSearchCV(estimator = rf, iid=True,param_distributions = random_grid, n_iter = 10, cv = 3, verbose=0,n_jobs=-1)# Fit the random search model
...
#lasalgaon_high_anomaly=lasalgaon_high_anomaly
#bangalore_high_anomaly=bangalore_high_anomaly
#azadpur_high_anomaly=azadpur_high_anomaly
...
#                        [lasalgaon_mandi-lasalgaon_mandi_arimax2],azadpur_high_anomaly,bangalore_high_anomaly,
